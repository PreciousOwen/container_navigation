"""Django settings for daudi_project.

This file is safe to use in production when configured via environment
...
ALLOWED_HOSTS = [
    ...
    for host in os.environ.get(
        ...
        "wosac.silicon4forge.org,localhost,127.0.0.1",
    ).split(",")
    if host.strip()
]
...
ROOT_URLCONF = "daudi_project.urls"
...
WSGI_APPLICATION = "daudi_project.wsgi.application"
...
# If you're behind Nginx terminating TLS, this makes Django treat the request as HTTPS.
